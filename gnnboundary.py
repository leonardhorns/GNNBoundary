...
def train_eval(cls_idx, dataset_name, num_runs, num_samples, train_args, use_gat=False, use_retrained=False,
               show_runs=False):
    start = time.time()
    ...
    logs = trainer.batch_generate(cls_idx, total=num_runs, num_boundary_samples=num_samples, show_runs=show_runs,
                                  **train_args)
...
if __name__ == "__main__":
    ...
    save_dir = "sampler_ckpts/REDDIT-BINARY"
